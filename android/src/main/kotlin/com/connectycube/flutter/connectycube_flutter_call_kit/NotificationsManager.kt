...
fun showCallNotification(
    ...
    val builder: NotificationCompat.Builder =
        createCallNotification(context, callInitiatorName, if (callType == 1) "Appel vidéo entrant" else "Appel audio entrant", pendingIntent, ringtone)
...
fun addCallRejectAction(
    ...
    val declineAction: NotificationCompat.Action = NotificationCompat.Action.Builder(
        ...
        getColorizedText("REJETER", "#E02B00"),
...
fun addCallAcceptAction(
    ...
    val acceptAction: NotificationCompat.Action = NotificationCompat.Action.Builder(
        ...
        getColorizedText("ACCEPTER", "#4CB050"),
        acceptPendingIntent
    )
        .build()
